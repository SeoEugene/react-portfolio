const EffertDataContext = [
    ...
    },
    {
        ...
        desc: "웹 사이트의 가장 기본 기능인 로그인과 회원가입을 구현해보았습니다. web localstorage를 이용한 javascript 기본의 로그인과 PHP의 MySQL 데이터베이스를 이용한 로그인, FireBase 서비스를 이용한 Node.js 로그인을 제작하였습니다.",
        stack: [],
        effectImage: "/image/join.png",
        url: ""
    },
    {
        title: "Board",
        desc: "사이트의 기본이 되는 게시판 사이트를 PHP와 Node.js, 그리고 Next.js를 이용해서 만들어보았습니다. 게시판은 데이터베이스의 CRUD의 기능이 구현되어 있으며 주로 사용한 데이터베이스는 MongoDB, MySQL를 이용하였습니다.",
        stack: [],
        effectImage: "/image/board.png",
        url: ""
    },
    {
        title: "Comment",
        desc: "댓글과 채팅 기능을 구현해보았습니다.",
        stack: [],
        effectImage: "/image/comment.png",
        url: ""
    },

]
export default EffertDataContext;